...
class Camera:
    ...
    def _create_pipeline(self):
        ...
        # Resize
        #resizer = pipeline.create(dai.node.ImageManip)
        #resizer.initialConfig.setResize(640, 640)
        #cam_rgb.preview.link(resizer.inputImage)
        ...
        #spatial_nn.setBlobPath(blobconverter.from_zoo(name='mobilenet-ssd', shaves=6)) BLOB CON SHAVES 6 convertir 
        spatial_nn.setBlobPath('/home/ivianx/Desktop/ConejosModelo/result/best_openvino_2022.1_6shave.blob')
        ...
        #resizer.out.link(spatial_nn.input)
